                    ...
                    <div class="card-body">
                        ...
                        <div class="profile-info">
                            ...
                            <p class="profile-status">
                                @php
                                    $status = $user->status ? '<span class="label label-success">Active</span>' : '<span class="label label-danger">Inactive</span>';
                                @endphp
                                {!! $status !!}
                            </p>
                        </div>
                        ...
                        <div class="profile-actions mt-4">
                            <a href="{{ URL::to('/admin/edit_profile/' . $user->id) }}" class="btn btn-primary btn-animated">Edit Profile</a>
                        </div>
                    </div>
                </div>
            </div>
