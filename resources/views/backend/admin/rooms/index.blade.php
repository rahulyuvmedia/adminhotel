    ...
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div class="d-inline-block ml-2 pb-3">
                <a href="{{ URL::to('admin/rooms/create') }}" class="btn" style="background-colo">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex">
                        ...
                        @if ($value->status == 1)
                        <a class="btn btn-success" href="{{ URL::to('admin/rooms/active', $value->id) }}">Active</a>
                        @elseif ($value->status == 0)
                        <a class="btn btn-danger" href="{{ URL::to('admin/rooms/inactive', $value->id) }}">Inactive</a>
                        @else
