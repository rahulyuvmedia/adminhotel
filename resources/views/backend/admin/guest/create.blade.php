                        ...
                        <div class="row">
                            <div class="d-flex flex-wrap justify-content-between align-items-center  p-3">
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
                                    ...
                                    @error('check_in')
                                    <div class="has-error mt-2" style="color: red">Check in is required.</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
                                    ...
                                    @error('check_out')
                                    <div class="has-error mt-2" style="color: red">Check out is required.</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
                                    ...
                                    <select class="form-select" id="roomNumber" name="roomNumber"
                                        ...
                                        <option value="{{ $value->id }}" data-price="{{ $value->price }}" @if ($value->
                                            id == $roomNumber) selected @endif>
                                            {{ $value->roomNumber }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                    @error('roomNumber')
                                    <div class="has-error mt-2" style="color: red">Room No. is required.</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
                                    ...
                                    @error('member')
                                    <div class="has-error mt-2" style="color: red">Member is required.</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
                                    ...
                                    @error('child')
                                    <div class="has-error mt-2" style="color: red">Child is required.</div>
                                    @enderror
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center  p-3">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
                                    ...
                                    @error('name')
                                    <div class="has-error mt-2" style="color: red">Name is required.</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
                                    ...
                                    @error('mobile')
                                    <div class="has-error mt-2" style="color: red">Phone is required.</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
                                    ...
                                    @error('address')
                                    <div class="has-error mt-2" style="color: red">Address is required.</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
                                    ...
                                    @error('aadharNo')
                                    <div class="has-error mt-2" style="color: red">Aadhar No. is required.</div>
                                    @enderror
                                </div>
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center  p-3">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
                                    ...
                                    @error('bookingSource')
                                    <div class="has-error mt-2" style="color: red">Field is required.</div>
                                    @enderror
                                </div>
                                <div class="col-lg-2 col-md-3 col-sm-12 ">
            ...
            <div class="card">
                ...
                <div class="card-body p-3" id="pdfContent">
                    ...
                    <div class="text-center">
                        <a href="#" class="app-brand-link">
                            <span class="app-brand-logo demo">
                                <img src="{{ asset('/assets/img/icon.svg') }}" class="img-fluid" alt="Yuvmedia Logo" />
                            </span>
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <div class="col-lg-5">
                            <div class="card-body">
                                <h6 class="card-title text-center">Check-in</h6>
...
function updateRoomPrice() {
    ...
    if (checkInDisplay) {
        var formattedCheckIn = formatDateTime(checkInTime);
        checkInDisplay.textContent = '' + formattedCheckIn;
    }

    // Display check-out time
    var checkOutDisplay = document.getElementById('checkOutDisplay');
    if (checkOutDisplay) {
        var formattedCheckOut = formatDateTime(checkOutTime);
...
function formatDateTime(dateTime) {
    ...
    return new Intl.DateTimeFormat('en-IN', options).format(dateTime);
}
</script>
