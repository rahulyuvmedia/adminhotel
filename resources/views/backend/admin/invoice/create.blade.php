                ...
                <div class="card-body">
                    ...
                    <div class="row p-sm-4 p-0">
                        <div class="col-md-6 col-sm-5 col-12 mb-sm-0 mb-4">
                            ...
                            <span id='room_charge_display' class="" style="border: none; color:gray;" readonly>{!!
                                $stayPrice['formattedStayAmount'] !!}</span>
                        </div>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr id="account_detail_row">
                                        <td class="pe-4">Account detail/Number:</td>
                                        <td></td>
                                    </tr>
                                ...
                                <div class="d-flex border rounded position-relative pe-0">
                                    <div class="row w-100 p-3">
                                        ...
                                        <div class="col-md-4 col-12 mb-md-0 mb-3">
                                            ...
                                            <input type="number" name='room_charge' id='room_charge'
                                                ...
                                                value="{{ $stayPrice['totalStayAmount'] }}" placeholder="00" readonly />
                                    ...
                                    <div
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <i class="ti ti-receipt ti-xs cursor-pointer more-options-dropdown"
                            ...
                            <div class="col-md-6 mb-md-0 mb-3">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" rows="2"
                                        id="notes" name='notes' placeholder="Invoice note"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 d-flex justify-content-end">
                                <div class="invoice-calculations">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span id='room_charge_display' class="" style="border: none;" readonly>{!!
                                            $stayPrice['formattedStayAmount'] !!}</span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span id="total_display" class="fw-medium"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    maxDigitLimit('#due_amount', 6);
    maxDigitLimit('#account_detail', 14);
    ...
    function updatePrice() {
        ...
        $('#total_display').text('₹' + totalPrice.toFixed(2));
    }
...
<script>
$(document).ready(function() {
    // Initial setup: hide all account-related fields
    ...
    $('#pay_method').on('change', function() {
        ...
        updateLabels(selectedMethod);

        // Show the relevant account-related fields based on the selected payment method
        if (selectedMethod === 'Bank Account' || selectedMethod === 'UPI Transfer') {
            $('#account_holder, #account_detail').show();
        } else {
            // Hide account-related fields for other payment methods
            // $('#account_holder, #account_detail').hide();
        }

        // Update table rows with the filled data, including payment method
        updateTableRows();
    });

    // Listen for input changes in account-related fields
    $('#account_holder, #account_detail').on('input', function() {
        updateTableRows();
    });

    function updateLabels(paymentMethod) {
        // Map payment method to corresponding labels
        var labelMapping = {
            'Bank Account': 'Account Holder Name:',
            'UPI Transfer': 'Account Holder Name:',
            'Cash': 'Name:',
            'Paypal': 'Name:',
            'Card': 'Name:'
    ...
    function updateTableRows() {
        ...
        // Update labels based on the selected payment method
        updateLabels(paymentMethod);

        // Update table rows with the filled data
