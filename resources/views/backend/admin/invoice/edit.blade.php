                                 ...
                                 <div class="row m-sm-4 m-0">
                                     ...
                                     <div class="col-md-5">
                                         <dl class="row mb-2">
                                             ...
                                             <dd class="col-sm-6 d-flex justify-content-md-end pe-0 ps-0 ps-sm-2">
                                                 <input type="text" class="form-control w-px-150 due-date"
                                                     placeholder="YYYY-MM-DD" />
                                             </dd>
                                         </dl>
                                     </div>
                                             ...
                                             <div class="d-flex border rounded position-relative pe-0">
                                                 <div class="row w-100 p-3">
                                                     ...
                                                     <div class="col-md-3 col-12 mb-md-0 mb-3">
                                                         ...
                                                         <input type="number"
                                                             class="form-control invoice-item-price mb-3" value="24"
                                     ...
                                     <div class="col-md-6 mb-md-0 mb-3">
                                         <div class="d-flex align-items-center mb-3">
                                             <label for="salesperson"
                                                 class="form-label me-4 fw-medium">Salesperson:</label>
                             ...
                             <div class="card-body">
                                 ...
                                 <div class="d-flex my-2">
                                     <a href="app-invoice-preview.html"
                                         class="btn btn-label-secondary w-100 me-2">Preview</a>
